			...
			if (newLocation.QuestAvailableHere != null)
			{
					...
					if (!playerAlreadyCompletedQuest)
					{
						...
						foreach (QuestCompletionItem qci in newLocation.QuestAvailableHere.QuestCompletionItems)
						{
							...
							if (!foundItemInPlayersInventory)
							{
								...
								// There is no reason to continue checking for other quest items
								break;
							}
						}
						...
						if (playerHasAllItemsToCompleteQuest)
						{
							...
							foreach (InventoryItem ii in _player.Inventory)
							{
								...
								{
									// They have item in their inventory,so increase the quantity by one
									ii.Quantity++;
				...
				else
				{
					...
					foreach (QuestCompletionItem qci in newLocation.QuestAvailableHere.QuestCompletionItems)
					{
						if(qci.Quantity == 1)
						{
							rtbLocation.Text += qci.Quantity.ToString() + " " + qci.Details.Name + Environment.NewLine;
						}
						else
						{
